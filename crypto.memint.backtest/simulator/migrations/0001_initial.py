    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_capital', models.DecimalField(decimal_places=2, max_digits=14)),
                ('final_capital', models.DecimalField(decimal_places=2, max_digits=14, null=True)),
                ...
                ('symbols', models.ManyToManyField(related_name='simulations', to='simulator.symbol')),
